...
export default function MasterClassEdit() {
	...
	async function masterclassskills(skill1, skill2, skill3, skill4, skill5) {
		const url = `${import.meta.env.VITE_SERVER_URL}/masterclass/addmasterclassskills`;
	...
	async function senddata(
		...
		const url = `${import.meta.env.VITE_SERVER_URL}/masterclass/addmasterclass`;
		const { data } = await axios.post(url, {
			title: title,
			date: date,
			speaker: speaker,
	...
	async function sendfeedbackserver(files) {
		...
		const url = `${import.meta.env.VITE_SERVER_URL}/masterclass/addmasterclasssfeedback`;
		try {
	...
	async function sendfeedbacklinkserver(links) {
		const url = `${import.meta.env.VITE_SERVER_URL}/masterclass/addmasterclassfeddbackvid`;
		const { data } = await axios.post(url, {
			links: links,
		});
		console.log(data);
	...
	async function senddiscount(discount) {
		const url = `${import.meta.env.VITE_SERVER_URL}/masterclass/addmasterclassdiscount`;
		const { data } = await axios.post(url, {
			discount: discount,
		});
		// alert(data.message);
	...
	async function sendspeakerdetails(formdata) {
		const url = `${import.meta.env.VITE_SERVER_URL}/masterclass/addspeakerdetails`;
	...
	async function sendfollowers(instagram, twitter, linkedin, youtube) {
		const url = `${import.meta.env.VITE_SERVER_URL}/masterclass/addmasterclassfollowers`;
		const { data } = await axios.post(url, {
			instagram: instagram,
			twitter: twitter,
			linkedin: linkedin,
	...
	async function sendfaq(faq) {
		const url = `${import.meta.env.VITE_SERVER_URL}/masterclass/addmasterclassfaq`;
		const { data } = await axios.post(url, {
			faq: faq,
		});
		console.log(data);
