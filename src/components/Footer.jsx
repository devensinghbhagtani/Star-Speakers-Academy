...
function Footer() {
  return (
    <div>
      <div className="flex text-sm w-full h-[300px] bg-zinc-800 justify-center items-center overflow-hidden">
        <div className=" text-white w-[1080px] h-[200px]  items-center flex justify-between">
          ...
          <div className="explore h-full flex flex-col  gap-4">
